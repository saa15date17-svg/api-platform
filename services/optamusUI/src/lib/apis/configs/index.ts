...
export const importConfig = async (token: string, config: Record<string, unknown>): Promise<boolean> => {
	let error = null;
...
export const exportConfig = async (token: string): Promise<Record<string, unknown>> => {
	let error = null;
...
export const getConnectionsConfig = async (token: string): Promise<ConnectionConfig> => {
	let error = null;
...
export const setConnectionsConfig = async (token: string, config: ConnectionConfig): Promise<boolean> => {
	let error = null;
...
export const setToolServerConnections = async (token: string, connections: ToolServerConnection[]): Promise<boolean> => {
	let error = null;
...
export const getTerminalServerConnections = async (token: string): Promise<TerminalServerConnection[]> => {
	let error = null;
...
export const setTerminalServerConnections = async (token: string, connections: TerminalServerConnection[]): Promise<boolean> => {
	let error = null;
 ...
 * Proxied through the Optamus AI backend to keep API keys server-side.
 */
 ...
 */
export const verifyTerminalServerConnection = async (token: string, connection: TerminalServerConnection): Promise<boolean> => {
	let error = null;
...
export const verifyToolServerConnection = async (token: string, connection: ToolServerConnection): Promise<boolean> => {
	let error = null;
...
// RegisterOAuthClientForm is imported from $lib/types/api
...
export const setCodeExecutionConfig = async (token: string, config: CodeExecutionConfig): Promise<boolean> => {
	let error = null;
...
export const getModelsDefaults = async (token: string): Promise<Record<string, unknown>> => {
	let error = null;
...
export const setModelsConfig = async (token: string, config: ModelsConfig): Promise<boolean> => {
	let error = null;
