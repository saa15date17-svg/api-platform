...
export const createNewChannel = async (token: string = '', channel: ChannelForm): Promise<ChannelModel> => {
	let error = null;
...
export const getChannels = async (token: string = ''): Promise<ChannelModel[]> => {
	let error = null;
...
export const getChannelById = async (token: string = '', channel_id: string): Promise<ChannelModel> => {
	let error = null;
...
export const getDMChannelByUserId = async (token: string = '', user_id: string): Promise<ChannelModel> => {
	let error = null;
