...
# For Integrations (MCP tool OAuth clients)
        ...
        url=(
            ...
            if embedding_engine == 'openai'
                ...
                if embedding_engine == 'ollama'
                    ...
                    rag_config.get('rag.azure_openai.base_url')
        ...
        key=(
            ...
            if embedding_engine == 'openai'
                ...
                if embedding_engine == 'ollama'
                    ...
                    rag_config.get('rag.azure_openai.api_key')
                    if embedding_engine == 'azure_openai'
                    else rag_config.get('rag.gemini.api_key')
                )
            )
        ),
...
# Bifrost proxy — thin passthrough to the AI gateway
app.include_router(bifrost_proxy.router, tags=['bifrost'])
...
# NOTE: Anthropic-to-OpenAI format conversion is now handled by Bifrost.
# The /api/v1/messages endpoint has been removed.
##################################
