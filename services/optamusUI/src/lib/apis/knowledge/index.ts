...
export const getExternalKnowledgeConnections = async (token: string): Promise<ExternalKnowledgeConnection[]> => {
	let error = null;
...
export const createExternalKnowledgeConnection = async (token: string, connection: ExternalKnowledgeConnection): Promise<boolean> => {
	let error = null;
...
export const deleteExternalKnowledgeConnection = async (token: string, id: string): Promise<boolean> => {
	let error = null;
...
export const testExternalKnowledgeConnection = async (token: string, id: string): Promise<boolean> => {
	let error = null;
...
export const testExternalKnowledgeSource = async (token: string, payload: ExternalKnowledgeSource): Promise<boolean> => {
	let error = null;
...
export const createExternalKnowledgeSource = async (token: string, payload: ExternalKnowledgeSource): Promise<boolean> => {
	let error = null;
...
export const updateExternalKnowledgeSource = async (token: string, id: string, payload: ExternalKnowledgeSource): Promise<boolean> => {
	let error = null;
...
export const createExternalKnowledge = async (token: string, payload: Record<string, unknown>): Promise<boolean> => {
	let error = null;
...
export const getKnowledgeBases = async (token: string = '', page: number | null = null): Promise<KnowledgeListResponse> => {
	let error = null;
...
export const getKnowledgeById = async (token: string, id: string): Promise<KnowledgeResponse> => {
	let error = null;
...
export const getPendingKnowledgeFiles = async (token: string, id: string): Promise<Record<string, unknown>[]> => {
	let error = null;
...
// KnowledgeUpdateForm is imported from $lib/types/api

export const updateKnowledgeById = async (token: string, id: string, form: KnowledgeUpdateForm): Promise<boolean> => {
	let error = null;
...
export const updateFileFromKnowledgeById = async (token: string, id: string, fileId: string): Promise<boolean> => {
	let error = null;
...
export const removeFileFromKnowledgeById = async (token: string, id: string, fileId: string): Promise<boolean> => {
	let error = null;
...
export const resetKnowledgeById = async (token: string, id: string): Promise<boolean> => {
	let error = null;
...
export const deleteKnowledgeById = async (token: string, id: string): Promise<boolean> => {
	let error = null;
...
export const reindexKnowledgeFiles = async (token: string): Promise<boolean> => {
	let error = null;
