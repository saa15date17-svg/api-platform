...
class EventDefinitions(BaseModel):
    ...
    ADMIN_CONFIG_UPDATED: EventDefinition = EventDefinition(
        name='admin.config.updated', description='Admin configuration was updated.', message='Admin Config updated'
    )
