...
import type { AdminConfig, LdapServerConfig, OAuthConfig, UserProfileUpdate } from '$lib/types';
...
export const updateOAuthConfig = async (token: string, body: OAuthConfig) => {
	let error = null;
...
export const updateUserProfile = async (token: string, profile: UserProfileUpdate) => {
	let error = null;
